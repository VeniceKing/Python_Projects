...
class SearchPageLocators(object):
    ...
    sort_list_desc = (By.CSS_SELECTOR, '#content > div.page-search-results.container > div:nth-child(2) > div > div > div.wrapper-module-result.multiple > div > div.row.result-header.primary-result-header > div.wrapper-sort-results > div > ul > li:nth-child(4) > button')
